	...
	<div class="container">
		...
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				$total_records = mysqli_num_rows($result_search);
				...
				$result = mysqli_query($con, "SELECT * FROM khachhang WHERE 
            ...
            // nếu current_page > 1 và total_page > 1 mới hiển thị nút prev
						if ($current_page > 1 && $total_page > 1){
							echo '<li class="page-item"><a href="searchview.php?page='.($current_page-1).'">Prev</a></li>';
						}
						else {
            ...
            // Lặp khoảng giữa
                ...
                // ngược lại hiển thị thẻ a
							if ($i == $current_page){
								...
								echo '<li class="page-item"><a href="searchview.php?page='.$i.'" class="page-link">'.$i.'</a></li>';
							}
						}

            // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
						if ($current_page < $total_page && $total_page > 1){
							echo '<li class="page-item"><a href="searchview.php?page='.($current_page+1).'">Next</a></li>';
						}
						else {
